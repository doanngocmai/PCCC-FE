  ...
  <div class="grid grid-cols-12 gap-6">
    <va-card v-if="lineChartDataGenerated" class="col-span-12 lg:col-span-6">
      <va-card-title>
        ...
        <div>
          <va-button class="m-1" size="small" color="danger" :disabled="datasetIndex === minIndex"
            @click="setDatasetIndex(datasetIndex - 1)">
            {{ t('dashboard.charts.showInLessDetail') }}
          </va-button>
          <va-button class="m-1" size="small" color="danger" :disabled="datasetIndex === maxIndex - 1"
            @click="setDatasetIndex(datasetIndex + 1)">
